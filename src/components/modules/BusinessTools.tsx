          ...
          <CardContent className="space-y-3">
            <div className="grid gap-3 md:grid-cols-2">
              {basQuarters.map((quarter) => {
                const hasReminder = reminders.some((reminder) => reminder.label === quarter.label);
                return (
                  <div
                    key={quarter.label}
                  ...
                  >
                    <div className="space-y-1">
                      <p className="text-sm font-semibold text-slate-900">{quarter.label}</p>
